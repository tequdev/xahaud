...
pwd &&
( wget -nc -q https://github.com/Kitware/CMake/releases/download/v3.25.3/cmake-3.25.3-linux-x86_64.tar.gz -o cmake-linux-x86_64.tar.gz; echo "" ) &&
tar -xzf cmake-linux-x86_64.tar.gz -C /hbb/ &&
ln -sf /hbb/cmake-linux-x86_64/bin/cmake /hbb/bin/cmake &&
